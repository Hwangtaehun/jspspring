...
public class BookController {
	...
	public void downloadBookImage(@RequestParam("file") String paramKey, HttpServletResponse response) throws IOException {
		...
		response.setHeader("Content-disposition", "attackment;filename=\"" + paramKey + "\"");
	...
	public void initBinder(WebDataBinder binder) {
		...
		binder.setAllowedFields("bookId","name","unitPrice","author","description","publisher","category","unitsInStock","totalPage","releaseDate","condition", "bookImage");
	}
}
